...
ll func(ll i,ll cnt,ll sum){
    ...
    ll ans=0;
    ans=ans+func(i+1,cnt+1,sum+vec[i]);
    ans=ans+func(i+1,cnt,sum);
...
int main()
{
    ...
    while(test--){
        ...
        // }
        ll tot=ncr(m,n);
        ll answer=func(0,0,0);
        cout<<"Game "<<tno++<<" -- ";
        cout<<answer<<" : "<<tot-answer<<nn;
    }
