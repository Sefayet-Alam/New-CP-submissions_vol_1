...
int main()
{
    ...
    while(t--){
        ...
        while(q--){
            ...
            if(x==1){
                cin>>x;
                ll temp=querySegTree(0,0,n-1,x,x);
                cout<<temp<<endl;
                //updateValSegTree(0,0,n-1,x-1,-temp);
                updateLazySegTree(0,0,n-1,x,x,-temp);
            }
            else if(x==2){
                cin>>x>>l;
                //updateValSegTree(0,0,n-1,x-1,l);
                updateLazySegTree(0,0,n-1,x,x,l);

            }
            else{
                cin>>l>>r;
                ll ans=queryLazySegTree(0,0,n-1,l,r);
                cout<<ans<<endl;
            }
        }
    }
