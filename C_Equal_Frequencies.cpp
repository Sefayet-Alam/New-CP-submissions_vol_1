    ...
    while(t--){
        ...
        for(auto it:freq){
           // cout<<it.first<<" "<<it.second<<endl;
            if(it.second>0){
            if(it.second>maxm) maxchar=it.first;
            maxm=max(maxm,it.second);
            minm=min(minm,it.second);
            }
        }

       ll mid=(maxm+minm+1)/2;
        string t="";
        string t2="";
        ll ans=100000;
        ll ans2=0;
                ...
                if(freq2[itr]==mid) t2+=itr;
                    ...
                    if(freq2[itr]>mid){
                        ...
                        for(auto it:freq2){
                            if(it.second>mid){
                            t2+=(char)it.first;
                            freq2[it.first]=min(0LL,freq2[it.first]-1);
                            break;
                            }
