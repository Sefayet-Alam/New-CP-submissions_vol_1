...
int main()
{
    ...
    while(t--){
        ...
        while(f--){
            cin>>s;
            cin>>a>>b>>c>>d>>e;
            score=(double)0.56*(a)+ (double)0.24*(b)+ (double)0.14*(c)+ (double)0.06*(d)+(double)0.3*(e);
            mp[s]=score;
        }
       ...
       double tot=0;
        for(auto it:vec){
           // cout<<it.first<<" "<<it.second<<endl;
            minm=min(minm,it.first);;
            tot+=it.first;
        }
        // cout<<minm<<endl;
        //cout<<endl;
    //    for(ll i=0;i<vec.size();i++){
    //     if(minm!=0) vec[i].first/=minm;
    ...
    ll ans=0;
       //cout<<tot<<endl;
         for(auto it:vec){
            //cout<<ceil((it.first*(n-5))/tot)<<" "<<it.second<<endl;
            if(it.second=="Taiwan") ans=ceil((it.first*(n-5))/tot);
        }
        cout<<ans+1<<endl;
