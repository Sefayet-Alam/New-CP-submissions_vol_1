...
bool cmp(pair<string,pair<ll,string> >a,pair<string,pair<ll,string> >b){
  if(a.first != b.first){
    ...
    if(a.second.first!=b.second.first){
         if(a.second.first>b.second.first) a>b;
         return a>b;
    }
    else{
        if(a.second.second<b.second.second)  return a<b;
        return a>b;
    }
  }
}
int main()
{
    ...
    while(t--){
        ll n;
        cin>>n;
        vector<pair<string,pair<ll,string> > >vec;
        for(ll i=0;i<n;i++){
            string a,b,s;
            ll k;
            cin>>s>>k>>a>>b;
