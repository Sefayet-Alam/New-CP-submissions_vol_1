    ...
    while(t--){
      ...
      for(auto it:mp){
        ...
        if(it.first-prev>1){
            ...
            ex+=(it.first-prev-1)*d;
        }
        }
        pref[it.first]=ex+tot;
        pref2[it.first]=n-curr;
        prev=it.first;
      }
      tot+=ex;
      ll ans1=n*c+d;
      ll ans=min(ans1,tot);
      for(auto it:mp){
        //cout<<it.first<<" "<<pref[it.first]<<" "<<pref2[it.first]<<" "<<ans2<<endl;
        ans=min(ans,pref[it.first]+pref2[it.first]*c);
      }
