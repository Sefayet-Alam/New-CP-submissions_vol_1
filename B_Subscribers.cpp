...
int main()
{
    ...
    while(t--){
        ...
        cin>>n;
        if(n<1000){}
        else if(n<10000){n=n-n%10;}
        else if(n<100000){n=n-n%100;}
        else if(n<1000000){n=n-n%1000;}
        else if(n<10000000){n=n-n%10000;}
        else if(n<100000000){n=n-n%100000;}
        else if(n<1000000000){n=n-n%1000000;}
      cout<<n<<nn;
    }
